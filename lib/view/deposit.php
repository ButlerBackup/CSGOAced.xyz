...
<div class="col-sm-4">
	<a class="btn btn-info btn-md refresh-inventory"><span class="glyphicon glyphicon-refresh"></a>
	<a class="btn btn-info btn-md update-inventory"><span class="glyphicon glyphicon-repeat"> Reload Inventory</a>
