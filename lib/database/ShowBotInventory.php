...
$sth->execute(array(':UID' => $Vars->BotUID));
$skins = $sth->fetchAll();
		...
		<div class="col-xs-6 col-md-3">
			<div class="thumbnail">
				...
				<div class="caption">
					...
					<button type="button" class="btn btn-info btn-md addCart" data-icon="https://steamcommunity-a.akamaihd.net/economy/image/<?php echo $skin['IconURL'];?>/500fx300f" data-name="<?php echo $skin['MarketName'];?>" data-price="<?php echo $skin['SellPrice'];?>" data-assetID="<?php echo $skin['AssetID'];?>" data-classID="<?php echo $skin['ClassID'];?>">Withdraw <span class="glyphicon glyphicon-shopping-cart"></span></button>
				</div>
			</div>
		</div>
	<?php
